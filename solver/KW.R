...
library(dunn.test)
post_hoc_res=dunn.test(data_bezOP$`automaticke mereni` , data_bezOP$`typ abraziva`,method="bonferroni")
...
means_all=tapply(data_bezOP$`automaticke mereni` , data_bezOP$`typ abraziva`,quantile,0.5)
